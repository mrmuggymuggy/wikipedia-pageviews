...
3. Bonus: if you have Datadog agent deployed in your cluster, you will have automatically spark metrics in Datadog :) see `airflow-dags/wiki_pageviews_batch_job.py` `datadog_autodiscovery_conf`
